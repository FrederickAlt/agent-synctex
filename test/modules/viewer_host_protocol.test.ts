...
test("Viewer Host protocol validates representative MCP to Host messages", () => {
	const messages: McpToViewerHostMessage[] = [
		...
		{ type: "reverse_synctex_hover_result", pdf_id: 123, request_id: 7, page: 2, x: 100, y: 500, source_file: "/tmp/main.tex", line: 42, column: 0, source_line: "hello", rect: { left: 10, top: 20, right: 30, bottom: 40 }, precision: "verified", nearest_candidate: { source_file: "/tmp/main.tex", line: 78, column: 0, source_line: "\\end{document}", score: 1000, structural: true, distance: 0 }, repaired: { source_file: "/tmp/main.tex", line: 42, column: 0, source_line: "hello", precision: "verified" }, candidates: [{ source_file: "/tmp/main.tex", line: 78, column: 0, source_line: "\\end{document}", score: 1000, structural: true, distance: 0 }, { source_file: "/tmp/main.tex", line: 42, column: 0, source_line: "hello", score: 4, structural: false, distance: 4 }], forward: { attempted: true, contains_click: true, boxes_considered: 2, boxes_filtered: 1, chosen_box: { page: 2, h: 10, v: 20, W: 30, H: 4 } } },
